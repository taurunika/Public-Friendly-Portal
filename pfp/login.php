...
<html lang="en">
  <head>
    ...
    <meta name="description" content="publicfriendlyportal.com">
    <meta name="keywords" content="HTML,CSS,XML,JavaScript">
    <meta name="author" content="Spoorthy M,Taurunika S,Shylashree M A">
    <!-- The above meta tags *must* come first in the head; any other head content must come *after* these tags -->

    <title>Public Friendly portal</title>
